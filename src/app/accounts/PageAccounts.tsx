...
export const PageAccounts = () => {
  ...
  const { data: githubAccount, isLoading: isGithubLoading } = trpc.githubAccount.me.useQuery();
  const { data: gitlabAccount, isLoading: isGitlabLoading } = trpc.gitlabAccount.me.useQuery();
